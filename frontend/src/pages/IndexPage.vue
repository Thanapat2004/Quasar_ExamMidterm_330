...
// จากตัวอย่างก่อน
const gitSteps = [
  { title: 'Clone Repository', detail: 'Get the code' },
  { title: 'Create Branch', detail: 'Work in isolation' },
  { title: 'Commit & Push', detail: 'Save changes' }
];
const dockerItems = [
  { title: 'Containerization', detail: 'Package app' },
  { title: 'Images', detail: 'Blueprint for containers' }
];
